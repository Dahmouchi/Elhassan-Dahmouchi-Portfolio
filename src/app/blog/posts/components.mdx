...
<CodeBlock
    ...
    <Row fillWidth horizontal="center">
      <Card
        ...
        gap="8"
      >
        <SmartImage src="/images/projects/project-01/cover-01.png" aspectRatio="16/9" radius="l" sizes="400px" />
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    codePreview={<SmartImage src="/images/projects/project-01/cover-01.png" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codeInstances={[
      {
        code:
`<SmartImage
